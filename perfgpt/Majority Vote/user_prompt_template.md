This was a **Comp Arch** exercise. I am attaching **5 files**, each containing one independent LLM response to the same prompt.
...
The 5 responses are provided **only as attachments** (not pasted inline).
